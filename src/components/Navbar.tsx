    ...
    <nav className="fixed w-full z-60 px-6 py-3 mobile-nav glass" style={{ color: 'var(--mobile-text)' }}>
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="brand-stack">
          <Link to="/" className="text-2xl font-bold brand-link" style={{ color: 'var(--text-nav)' }}>
            A.F.
          </Link>
      ...
      >
        <div className="mobile-menu-inner">
          ...
          {/* Social quick links */}
          <a href="https://www.linkedin.com/in/lex-ferguson-3056a3275/" target="_blank" rel="noreferrer" className="mobile-menu-link">
          ...
          <a href="https://www.instagram.com/lexfergusonn/" target="_blank" rel="noreferrer" className="mobile-menu-link">
