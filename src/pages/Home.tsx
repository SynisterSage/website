    ...
    >
      <div className="mb-12 max-w-[980px]">
        ...
        <div className="flex gap-4">
          <Link to="/contact" className="px-6 py-3 bg-accent text-white rounded-lg hover:opacity-90 transition-opacity font-medium">Get in Touch</Link>
          <a href="#" className="btn-outline-accent font-medium">View Resume</a>
        </div>
      </div>
      ...
      <section className="mb-8">
        <div className="content-column w-full">
          <div className="flex justify-between items-center mb-6">
            ...
            <Link to="/projects" className="px-4 py-2 glass-light rounded-md hover:opacity-90 transition-opacity">All Projects</Link>
          </div>
      ...
      <section className="mb-16">
        <h4 className="text-[28px] font-medium mb-8">My Stack</h4>
        <div className="content-column w-full">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-x-4 gap-y-6 stack-grid">
          <div className="flex items-center gap-3 stack-item glass-light rounded-xl p-3 glass-hover">
